...
export function StatTile({
  ...
  const base =
    "group border border-border bg-card/50 backdrop-blur-sm p-4 sm:p-6 rounded-xl transition-all duration-300 block hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/5";
