...
export const GlobalBroadcast = () => {
  ...
  return React.createElement(Dialog, { open, onOpenChange: handleOpenChange },
    ...
    React.createElement(DialogContent, { className: "sm:max-w-[500px] border-none bg-background/95 backdrop-blur-xl" },
      ...
      React.createElement(DialogFooter, null,
        React.createElement(Button, { variant: "ghost", onClick: () => setOpen(false), disabled: broadcastMutation.isPending }, "Cancelar"),
