...
import { Route as ConfigGoogleRouteImport } from './routes/config-google'
...
const ConfigGoogleRoute = ConfigGoogleRouteImport.update({
  id: '/config-google',
  path: '/config-google',
...
export interface FileRoutesByFullPath {
  ...
  '/config-google': typeof ConfigGoogleRoute
...
export interface RootRouteChildren {
  ...
  ConfigGoogleRoute: typeof ConfigGoogleRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    '/config-google': {
      id: '/config-google'
      path: '/config-google'
      fullPath: '/config-google'
      preLoaderRoute: typeof ConfigGoogleRouteImport
...
const rootRouteChildren: RootRouteChildren = {
  ...
  AuthRoute: AuthRoute,
  ConfigGoogleRoute: ConfigGoogleRoute,
